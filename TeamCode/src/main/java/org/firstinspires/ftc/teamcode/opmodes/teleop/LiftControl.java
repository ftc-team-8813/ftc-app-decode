...
public class LiftControl extends ControlModule {
    ...
    private final double deposit_normal = 0.44; // TODO Rithwick up probably only need this but this will be normal wall and chamber position only define deposit up and down if you need it to rotate it up and down
    private final double deposit_up = 0.189;
    private final double deposit_down = 0.554;
