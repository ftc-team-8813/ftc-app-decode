...
public class GoBildaPath extends ArrayList<Waypoint> {
     ...
     */
    public GoBildaPath(Waypoint... waypoints) {
     ...
     */
    public boolean followPath(MecanumDrive mecanumDrive, GoBildaPinpointDriver odometry) {
        ...
        while (!isFinished()) {
            ...
            Pose2d robotPosition = new Pose2d(odometry.getPosX(),odometry.getPosY(),new Rotation2d(odometry.getHeading()));
     ...
     */
    public GoBildaPath setPathTimeout(long timeoutMiliseconds) {
     ...
     * @return This path, used for chaining methods.
     */
    public GoBildaPath setPathType(PathType pathType) {
     ...
     */
    public GoBildaPath setMotionProfile(PathMotionProfile profile) {
        if (profile == null)
     ...
     * @return This path, used for chaining methods.
     */
    public GoBildaPath setWaypointTimeouts(long... timeouts) {
     ...
     * @return This path, used for chaining methods.
     */
    public GoBildaPath setWaypointTimeouts(long timeout) {
     ...
     * @return This path, used for chaining methods.
     */
    public GoBildaPath setRetraceSettings(double movementSpeed, double turnSpeed) {
     ...
     * @return This path, used for chaining methods.
     */
    public GoBildaPath resetTimeouts() {
        timedOut = false;
        lastWaypointTimeStamp = System.currentTimeMillis();
        return this;
    }
     ...
     * @return This path, used for chaining methods.
     */
    public GoBildaPath enableRetrace() {
        retraceEnabled = true;
        return this;
    }
     ...
     * @return This path, used for chaining methods.
     */
    public GoBildaPath disableRetrace() {
     ...
     * @return This path, used for chaining methods.
     */
    public GoBildaPath addTriggeredActions(TriggeredAction... actions) {
     ...
     * @return This path, used for chaining methods.
     */
    public GoBildaPath removeTriggeredAction(TriggeredAction action) {
     ...
     * @return This path, used for chaining methods.
     */
    public GoBildaPath clearTriggeredActions() {
